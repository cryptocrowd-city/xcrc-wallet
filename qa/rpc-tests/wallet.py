...
#   c) node1 mines 32 blocks, so now node 0 has 60001XCRC node 1 has 4250XCRC node2 has none.
#   d) node0 sends 601 XCRCto node2, in two transactions (301 XCRC then 300 XCRC.
