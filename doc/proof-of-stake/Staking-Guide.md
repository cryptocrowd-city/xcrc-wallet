...
1. Make sure you have the latest wallet version downloaded from our [Github](https://github.com/bulwark-crypto/CRyptoCrowd/releases) and the wallet is fully synced with atleast 100 XCRC in each input. Also make sure that each input has atleast 475 confirmations.
